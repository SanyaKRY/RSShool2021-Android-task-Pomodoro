...
import com.example.pomodoro.MainActivity.Companion.COMMAND_ID
import com.example.pomodoro.MainActivity.Companion.COMMAND_START
import com.example.pomodoro.MainActivity.Companion.COMMAND_STOP
import com.example.pomodoro.MainActivity.Companion.INVALID
import com.example.pomodoro.MainActivity.Companion.TIMER_TIME_MS
...
class ForegroundService : Service() {
    ...
    private fun processCommand(intent: Intent?) {
        when (intent?.extras?.getString(COMMAND_ID) ?: INVALID) {
            COMMAND_START -> {
                val startTime = intent?.extras?.getLong(TIMER_TIME_MS) ?: return
